...
`ferry export <TAB>` adds the directories that hold sessions, ready for a name
after the colon; and `--memory` changes what is offered, because it changes
which of the store's two trees is being asked
